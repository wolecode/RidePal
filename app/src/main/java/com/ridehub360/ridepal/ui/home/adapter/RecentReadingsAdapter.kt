...
import com.ridehub360.ridepal.databinding.RecentReadingsAdapterBinding
import com.ridehub360.ridepal.model.DestinationModel
import com.ridehub360.ridepal.model.ReadingsModel

class RecentReadingsAdapter(val recycler: () -> RecyclerView) :
    RecyclerView.Adapter<RecentReadingsAdapter.ReadingsViewHolder>() {
    ...
    inner class ReadingsViewHolder(private val binding: RecentReadingsAdapterBinding) :
